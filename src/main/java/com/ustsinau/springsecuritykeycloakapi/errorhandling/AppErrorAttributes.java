package com.ustsinau.springsecuritykeycloakapi.errorhandling;

import com.ustsinau.springsecuritykeycloakapi.exception.*;
...
public class AppErrorAttributes extends DefaultErrorAttributes {
    ...
    private Map<String, Object> createErrorMap(ApiException apiException) {
        var errorMap = new LinkedHashMap<String, Object>();
